...
<div class="p-3 admin text-center text-black mt-3 cursor">
<span class="text-uppercase"><a href="../admin/order_table.php.php">Customer Orders</a></span>
</div>
</div>
</div>
...
<div class="p-3 admin text-center text-black mt-3 cursor">
<span class="text-uppercase"><a href="../admin/product_table.php">Courier Companies</a></span>
</div>
</div>
</div>
