<?php 
    ...
    if ( isset( $_POST['submit'] ) ) {
        ...
        oci_bind_by_name($stmt, ':id', $supplier_id);
        oci_bind_by_name($stmt, ':nme', $supplier_name);
        oci_bind_by_name($stmt, ':phn', $supplier_phone);
        oci_bind_by_name($stmt, ':cnt', $supplier_country);
        oci_bind_by_name($stmt, ':cmpny', $supplier_company);
